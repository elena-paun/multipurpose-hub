...
const Contact = () => {
  ...
  return (
    ...
    >
      <div
        id='contact'
        className='grid grid-cols-8 grid-rows-6 pointer-events-none'>
        <div className='col-start-2 row-start-3 col-span-3 row-span-3'>
          <div className='leading-none col-start-2 font-cheyra vertical-rl rotate-180  col-start-2 row-start-4 w-full col-span-3 text-9xl row-span-2'>
            CONTACT
          </div>
        </div>
      </div>
